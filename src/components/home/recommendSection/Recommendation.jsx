...
const Recommendation = () => {
  ...
  return (
    <div className="mx-auto max-w-[1440px] flex gap-4">
      <div className="bg-grayBg flex items-center h-[16vh] p-4 text-center sm:h-[24vh] justify-center relative flex-1 rounded-[20px] overflow-hidden">
      ...
      <div
        onClick={handleClick}
        className="bg-grayBg flex flex-2 items-center justify-center h-[16vh] p-4 text-center sm:h-[24vh] rounded-[20px] relative overflow-hidden"
      >
